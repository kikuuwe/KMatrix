...
template<class T,int M,int N> inline void
addM_mulVOSVT(KMatrix<T,M,N>* const pOut,const KVector<T,M>& A,const T& k,const KVector<T,N>& B){___xxxM_mulVOSVT___(+=)}
template<class T,int M,int N> inline void
minM_mulVOSVT(KMatrix<T,M,N>* const pOut,const KVector<T,M>& A,const T& k,const KVector<T,N>& B){___xxxM_mulVOSVT___(-=)}

template<class T,int M,int N> inline KMatrix<T,M,N>
mulVOSVT(const KVector<T,M>& A,const T& k,const KVector<T,N>& B){KMatrix<T,M,N> out;iniM_mulVOSVT(&out,A,k,B);return out;}
